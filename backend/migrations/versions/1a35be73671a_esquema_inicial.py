...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('numero_erogacion', 'grupo_utn_id', 'deleted_at', name='uq_erogacion_numero_activo')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('titulo_trabajo', 'deleted_at', name='uq_trabajo_reunion_activo')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('adoptante_id', 'transferencia_id', 'deleted_at', name='uq_adoptante_transferencia_activo')
    )
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('id_beca', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id_becario', 'id_proyecto', 'deleted_at', name='uq_becario_proyecto_activo')
    )
    ...
    op.create_table('investigador_actividad_grado',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('investigador_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['investigador_id'], ['investigador.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('investigador_id', 'actividad_docencia_id', 'grado_academico_id', 'fecha_inicio', name='uq_hist_grado_actividad')
    )
    op.create_table('investigadorxproyecto',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_investigador', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['id_proyecto'], ['proyecto_investigacion.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id_investigador', 'id_proyecto', 'deleted_at', name='uq_investigador_proyecto_activo')
    )
...
def downgrade():
    ...
    op.drop_table('investigador_actividad_grado')
