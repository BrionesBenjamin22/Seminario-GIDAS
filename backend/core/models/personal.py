...
class Becario(db.Model):
    ...
    proyectos = db.relationship('ProyectoInvestigacion', secondary=becario_proyecto, back_populates='becarios')
...
class Investigador(db.Model):
    ...
    trabajos_reunion_cientifica = db.relationship('TrabajoReunionCientifica', back_populates='investigador', cascade="all, delete-orphan")
    actividades_docencia = db.relationship('ActividadDocencia', back_populates='investigador', cascade="all, delete-orphan")
    participaciones_relevantes = db.relationship('ParticipacionRelevante', back_populates='investigador', cascade="all, delete-orphan")

    proyectos = db.relationship('ProyectoInvestigacion', secondary=investigador_proyecto, back_populates='investigadores')
